        ...
        <div className="lg:w-1/2 w-full mx-10 lg:ml-10 flex flex-col justify-between h-[80%] lg:h-auto">
          <div className="mb-20">
            ...
            <h2 className=" text-[#E99287] lg:text-3xl md:text-2xl text-xl flex items-center gap-3">
              ...
              <Typewriter
                ...
                onInit={(typewriter) => {
                  typewriter
                    .typeString(`print("Graphics Designer")`)
                    .pauseFor(1000)
                    .deleteAll()
          ...
          <div className="flex flex-col gap-2.5">
            <p className="text-[#607B96]">
              # you can also see it on my Instagram profile 
            </p>
            <p>
              <span className="text-[#4D5BCE]">Instagram_link</span>{" "}
              ...
              <a
                ...
                rel="noreferrer"
              >
                "https://www.instagram.com/manzoor__ahmed07"
              </a>
            </p>
          </div>
        </div>
